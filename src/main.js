...
class MarkupGenerator {
  ...
  processBlock() {
    ...
    let customRenderer = blockRenderers != null &&
      blockRenderers.hasOwnProperty(blockType)
...
export function stateToRTF(content: ContentState, options: ?Options): string {
  return new MarkupGenerator(content, { ...options, output: 'rtf' }).generate();
}
